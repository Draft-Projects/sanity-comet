...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/5ff8a6d26600bc0015d0ba46
...
To start editing your site, you can use the Sanity interface at https://sanity-comet-8a6d2.sanity.studio/.
...
Generated at `2021-01-08T18:41:07.873Z` by Stackbit version `0.3.42`.